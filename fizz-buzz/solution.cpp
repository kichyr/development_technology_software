...
static bool check_devision_3(long long int num) {
...
static bool check_devision_5(long long int num) {
    string str_num = to_string(num);
...
static string fizzbuzz_number(long long int number) {
...
int main() {
    vector<long long int> input_sequence;
    cin >> input_sequence;
